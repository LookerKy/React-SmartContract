...
export default function App() {
    ...
    const handleSubmit = async (e) => {
        ...
        const erc20 = new ethers.Contract(data.get("addr"), TwelveAnimalsABI, provider);

        const tokenName = await erc20.name();
        const tokenSymbol = await erc20.symbol();
        const totalSupply = await erc20.MAX_SUPPLY();
    ...
    const getMyBalance = async () => {
        ...
        const erc20 = new ethers.Contract(contractInfo.address, TwelveAnimalsABI, provider);
